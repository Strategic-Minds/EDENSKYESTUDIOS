    ...
    <main className="closet">
      ...
      <section className="section" id="models">
        <div className="heading">
          <p className="kicker">Model Vault</p>
          <h2>Every model stays visible, with her profile and next action.</h2>
        </div>
        <div className="modelGrid">
          {models.map(([name, country, tone, outfit, status, risk], index) => (
            <article className="card" key={name}>
              ...
              <div className="info">
                ...
                <p>{country} / {tone}</p>
                <p className="outfit">Current: {outfit}</p>
      ...
      <section className="section" id="approvals">
        <div className="heading">
          <p className="kicker">Approval Theater</p>
      ...
      <section className="section" id="workflow">
        <div className="heading">
          <p className="kicker">Automation Engine</p>
        ...
        <div className="workflowGrid">
          {workflow.map(([system, note, risk]) => (
            <article className="workflow" key={system}>
              <span className={`dot ${risk}`} /><h3>{system}</h3><p>{note}</p>
            </article>
          ))}
        </div>
      </section>
