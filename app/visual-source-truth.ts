...
export const visualSourceLock = {
  ...
  exactImageManifest: 'docs/EDEN_EXACT_IMAGE_SOURCE_MANIFEST_2026-06-12.json',
  exactImageCount: 19,
  rule: 'Render generated standalone source images only; uploaded collage/page boards remain layout references only and must never render as page/model/closet assets. The exact PNG filenames, SHA-256 hashes, and CDN URLs are locked in the exact image source manifest.'
} as const;
