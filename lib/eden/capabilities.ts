...
export const edenCapabilityRegistry: EdenCapability[] = [
  {
    ...
    bridgeRoutes: ['/api/bridge/github-move', '/api/bridge/stack-readiness'],
  ...
  },
  {
    ...
    bridgeRoutes: ['/api/bridge/drive-move', '/api/bridge/stack-readiness'],
  ...
  },
  {
    ...
    status: 'blocked',
    availableNow: ['repo-side route and cron definitions', 'Auto Builder bridge packet handoff'],
    bridgeRoutes: ['/api/bridge/stack-readiness'],
  ...
  },
  {
    ...
    status: 'partial',
    availableNow: ['read projects', 'get project details', 'list branches/functions/logs when project id is known', 'generate types', 'advisory reads'],
    bridgeRoutes: ['/api/bridge/stack-readiness'],
  ...
  },
  {
    ...
    bridgeRoutes: ['/api/xyla/draft', '/api/bridge/stack-readiness'],
